function Datos_Cartas_Habilidad() {
    ...
    var carta_dominar = new Cartas_Habilidad("Imagenes/Cartas/Habilidad/dominar.png", 0, "Habilidad", "Dominar", "Neutral", 0, 0, 2, 0, 0, "Experimentado", false, "-", 0, false, 0, false, 0, true, 1)
    var carta_golpe_brutal = new Cartas_Habilidad("Imagenes/Cartas/Habilidad/golpe_brutal.png", 0, "Habilidad", "Golpe Brutal", "Guardian", 0, 0, 1, 0, 0, "Experimentado", false, "-", 0, true, 1, false, 0, false, 0)
