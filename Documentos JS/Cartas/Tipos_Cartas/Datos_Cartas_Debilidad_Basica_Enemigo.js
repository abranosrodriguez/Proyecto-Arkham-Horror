function Datos_Cartas_Debilidad_Basica_Enemigo() {
    ...
    var carta_debilidad_basica_sacolito_del_crespusculo = new Cartas_Debilidad_Basica_Enemigos("Imagenes/Cartas/Debilidades/Enemigos/acolito_crepusulo_plata.png", "Debilidad Basica", "Acolito del Crepusculo de Plata", "Enemigo", "Humanoide | Sectario | Crepusculo de Plata", 2, 3, 3, 1, 0, true, false, "-", true, "Descripcion", "-")
